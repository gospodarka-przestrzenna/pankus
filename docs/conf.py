...
# -*- coding: utf-8 -*-
#
# pankus documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pankus', 'pankus Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pankus', 'pankus Documentation',
     author, 'pankus', 'One line description of project.',
     'Miscellaneous'),
]
